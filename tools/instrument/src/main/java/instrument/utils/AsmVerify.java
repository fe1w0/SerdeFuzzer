...
/**
 * ASM检查器，参考于dex2Jar:<a>http://code.google.com/p/dex2jar/source/browse/dex-tools/src/main/java/com/googlecode/dex2jar/tools/AsmVerify.java/</a>
 * 感谢dex2jar作者的支持
 * @author noverguo
 */
public class AsmVerify implements Opcodes {

    public static void check(InputStream in) throws IOException {
